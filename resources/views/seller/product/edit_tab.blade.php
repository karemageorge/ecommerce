  ...
  <div class="box-body">
    ...
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs" role="tablist" id="myTab">
        ...
        <li role="presentation"><a href="#prospec" aria-controls="home" role="tab" data-toggle="tab">Product
            Specification</a></li>

        <li role="presentation"><a href="#tags" aria-controls="messages" role="tab" data-toggle="tab">Faq</a></li>

        <li role="presentation"><a href="#rel" aria-controls="messages" role="tab" data-toggle="tab">Related Product
            Setting</a></li>
