             ...
             @endif
              ...
              <form action="{{ route('apply.cpn') }}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input value="{{ session()->has('coupanapplied') ? session()->get('coupanapplied')['code'] : '' }}" required="" class="form-control" name="coupon" type="text" placeholder="{{ __('staticwords.Haveacoupon') }}?">
                </div>
