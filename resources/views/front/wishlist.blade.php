                     ...
                     @if(isset($orivar) && $orivar->products->status == 1)
                      <div id="orivar{{ $orivar->id }}" class="row">
                          <div class="col-md-2 col-4">
                            <a href="{{ $url }}"> 
                              <img class="lazy wish-img" title="{{ $orivar->products->name }}" data-src="{{ url('variantimages/thumbnails/'.$orivar->variantimages['main_image']) }}" alt="{{ $orivar->variantimages['main_image'] }}">
                            </a>
                          </div>
