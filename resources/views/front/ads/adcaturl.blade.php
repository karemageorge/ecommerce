...
@foreach($old->subvariants as $orivar)
                              ...
                              if($commision_setting->type == "flat"){
                                ...
                                if($commision_setting->p_type == 'f'){
                                 ...
                                 if($old->tax_r !=''){
                                $cit =$commision_setting->rate*$old->tax_r/100;
                                $price =  $old->vender_price  + $commision_setting->rate+$orivar->price+$cit;
                                $offer =  $old->vender_offer_price  + $commision_setting->rate+$orivar->price+$cit;
                              }else{
                                $price =  $old->vender_price  + $commision_setting->rate+$orivar->price;
                                $offer =  $old->vender_offer_price  + $commision_setting->rate+$orivar->price;
                              }
