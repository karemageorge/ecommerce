...
@section('head-script')
  @php
        \Artesaos\SEOTools\Facades\SEOTools::setCanonical(\Request::fullUrl());
        \Artesaos\SEOTools\Facades\SEOTools::opengraph()->setUrl(\Request::fullUrl());
  @endphp
@endsection
@section("body")
        ...
        <div class="home-banner outer-top-n outer-bottom-xs">
            ...
            @else
                @if($isad->show_btn == '1')
                   ...
                   <img data-src="{{ url('images/detailads/'.$isad->adimage) }}" alt="advertise" class="lazy img-fluid">
                @elseif($isad->show_btn == 0 && $isad->top_heading != '')
                  ...
                  ">
                    <h3 class="buy-heading" style="color:{{ $isad->hcolor }}">{{ $isad->top_heading }}</h3>
                    <h5 class="buy-sub-heading" style="color:{{ $isad->scolor }}">{{ $isad->sheading }}</h5>
                    <img class="lazy img-fluid" data-src="{{ url('images/detailads/'.$isad->adimage) }}" alt="advertise">
                  </a>
                @else
                  <a href="
                  @if($isad->linkby == 'category')
                  ...
                  @endif
                  ">
                    <img class="lazy img-responsive img-fluid" data-src="{{ url('images/detailads/'.$isad->adimage) }}" alt="advertise">
                  </a>
                @endif
            @endif
        </div>
                              ...
                              <div class="item hot-deals-item">
                                <div class="products">
                                  <div class="hot-deal-wrapper">
                                    ...
                                    <a href="{{$url}}" title="{{$value->pro->name}}">
                                          ...
                                          @if(isset($orivar->variantimages['main_image']))
                                           <img class="owl-lazy {{ $orivar->stock == 0 ? "filterdimage" : ""}}" data-src="{{url('variantimages/thumbnails/'.$orivar->variantimages['main_image'])}}" alt="{{$value->name}}">
                                           <img class="owl-lazy {{ $orivar->stock == 0 ? "filterdimage" : ""}} hover-image" data-src="{{url('variantimages/hoverthumbnail/'.$orivar->variantimages['image2'])}}" alt=""/>
                                          @endif

                                          @else
                                          <img class="owl-lazy" title="{{ $value->name }}" data-src="{{url('images/no-image.png')}}" alt="{{ __('No Image') }}"/>
                                          @endif  
                                  ...
                                  <div class="product-info text-left m-t-20">
                                    ...
                                    @else
                                      <div class="text-center no-rating">{{'No Rating'}}</div>
                                    @endif
                                        ...
                                        <div class="product-price"> <span class="price">
                                              ...
                                              @php
                                                ...
                                                $result = ProductPrice::getprice($value->pro, $orivar)->getData();
                      
                                              @endphp
            
            
                                              @if($result->offerprice == 0)
                                                <span class="price"><i class="{{session()->get('currency')['value']}}"></i> {{ $result->mainprice }}</span>
                                              @else
                                                
                                                <span class="price"><i class="{{session()->get('currency')['value']}}"></i>{{round($result->offerprice,2)}}</span>
            
                                                <span class="price-before-discount"><i class="{{session()->get('currency')['value']}}"></i>{{ $result->mainprice }}</span>
...
@if(count($testimonials)>0)
      <div class="sidebar-widget outer-top-vs advertisement-main-block-one">
                <div id="advertisement" class="advertisement">
                  ...
                  <div class="item">
                    <div class="owl-lazy avatar"><img data-src="{{url('/images/testimonial/'.$value->image)}}" alt="Image"></div>
              ...
              <div class="stock-container info-container">
                ...
                <?php
                  ...
                  <p><i class="color147ED2 fa fa-handshake-o" aria-hidden="true"></i>  Trust of <b> {{$pro->brand->name}}</b>
                   ...
                   @else
                    <img alt="brandlogo" class="pro-brand" src="{{ Avatar::create($pro->brand->name)->toBase64() }}">
                   @endif
                  </p>
                ...
                <div class="col-lg-7 col-sm-6 col-xs-6 description-container">
                  <p></p>
                   <div class="delivery-location  description-heading">
                    ...
                    <img alt="shoppingbag" src="{{url('/images/shopping-bag.png')}}">{{ __('staticwords.deliverytext') }}
...
@if(isset($pro->key_features))
              <div class="description-container">
                ...
                <div class="report-text"><a href="#reportproduct" data-toggle="modal" title="">
                  <img alt="commenticon" src="{{url('/images/comment.png')}}">{{ __('staticwords.rprotext') }}.</a></div>
                    ...
                    <div class="row">
                       ...
                       <div class="col-md-8">
                          <p>
                            ...
                            <small class="pull-right rating-date">On {{ date('jS M Y',strtotime($alreadyrated->created_at)) }}
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-10">
                                    ...
                                    <div class="pull-left">
                                      ...
                                      <small class="pull-right rating-date">{{ __('On') }} {{ date('jS M Y',strtotime($review->created_at)) }}</small>
                                      <br>
   ...
   @if($alreadyrated)
    ...
    <div class="row">
        ...
        <div class="col-md-10 col-9">
          <p>
            <b><i>{{ $alreadyrated->users->name }}</i></b>
            <small class="pull-right rating-date">{{ __('On') }} {{ date('jS M Y',strtotime($alreadyrated->created_at)) }}
              @if($alreadyrated->status == 1)
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-10 col-xs-9">
                                    ...
                                    <div class="pull-left">
                                      ...
                                      <small class="pull-right rating-date">On {{ date('jS M Y',strtotime($review->created_at)) }}</small>
                                      <br>
                                      <span class="font-weight500">{{ $review->review }}</span>
                                    </p>
                                  </div>
...
<div class="card">
      ...
      <div class="owl-responsive owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                        ...
                        <div class="image {{ $orivar->stock ==0 ? "pro-img-box" : ""}}"> 
                                 ...
                                 <a href="{{$url}}" title="{{$relproduct->name}}">
                                  ...
                                  @if(isset($orivar->variantimages['image2']))
                                   <img class="owl-lazy ankit {{ $orivar->stock ==0 ? "filterdimage" : ""}}" data-src="{{url('/variantimages/thumbnails/'.$orivar->variantimages['main_image'])}}" alt="{{$relproduct->name}}">
                                   <img class="owl-lazy {{ $orivar->stock ==0 ? "filterdimage" : ""}} hover-image" data-src="{{url('/variantimages/hoverthumbnail/'.$orivar->variantimages['image2'])}}" alt=""/>
                                  @endif

                                  @else
                                  <img class="owl-lazy {{ $orivar->stock ==0 ? "filterdimage" : ""}}" title="{{ $relproduct->name }}" data-src="{{url('/images/no-image.png')}}" alt="No Image"/>
                       ...
                       <div class="product-image">
                        <div class="image {{ $orivar->stock ==0 ? "pro-img-box" : ""}}"> 
                                 ...
                                 <a href="{{$url}}" title="{{$pro->name}}">
                                  ...
                                  @if(isset($orivar->variantimages['image2']))
                                   <img class="owl-lazy ankit {{ $orivar->stock ==0 ? "filterdimage" : ""}}" data-src="{{url('/variantimages/thumbnails/'.$orivar->variantimages['main_image'])}}" alt="{{$pro->name}}">
                                   <img class="owl-lazy {{ $orivar->stock ==0 ? "filterdimage" : ""}} hover-image" data-src="{{url('/variantimages/hoverthumbnail/'.$orivar->variantimages['image2'])}}" alt=""/>
                                  @endif

                                  @else
                                  <img class="owl-lazy {{ $orivar->stock ==0 ? "filterdimage" : ""}}" title="{{ $pro->name }}" data-src="{{url('/images/no-image.png')}}" alt="No Image"/>
                       ...
                       @endphp
                          ...
                          <a href="{{$url}}" title="{{$value->pro->name}}">
                             @if(count($value->pro->subvariants)>0)
                                ...
                                @if(isset($orivar->variantimages['image2']))
                                 <img data-src="{{ url('/variantimages/thumbnails/'.$orivar->variantimages['main_image']) }}" alt="{{$value->name}}">
                                 <img class="owl-lazy hover-image" src="{{url('/variantimages/hoverthumbnail/'.$orivar->variantimages['image2'])}}" alt=""/>
                                @endif

                                @else
                                <img title="{{ $value->name }}" data-src="{{url('/images/no-image.png')}}" alt="No Image"/>
                                @endif
                          </a>
                          </div>
