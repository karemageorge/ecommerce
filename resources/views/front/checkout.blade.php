                    ...
                    <div class="margin-top8 col-md-6">
                      <div class="address address-1">
                        <div class="{{ $add == $address->id ? "active" : "user-header" }}">
                          ...
                          <h4><label><input {{ $add == $address->id ? "checked" : "" }} required type="radio"
                        ...
                        <div class="address-body">
                          @php
                          $c = App\Allcountry::where('id',$address->country_id)->first() ?
                          App\Allcountry::where('id',$address->country_id)->first()->nicename : '';
                          $s = App\Allstate::where('id',$address->state_id)->first() ?
                          App\Allstate::where('id',$address->state_id)->first()->name : '';
                          ...
                          <span class="font-weight500"> {{ strip_tags($address->address) }}, <br>
                            ...
                            <span>{{ $ci }},{{ $s }},{{ $c }}@if (isset($address->pin_code)), ({{ $address->pin_code }})
                              @endif</span>
                        </div>
                      </div>
                        ...
                        <div class="row">
                          ...
                          <div class="margin-top8 col-md-6 address-modal">
                            <div class="custom-control custom-radio">
                              <input value="{{ $address->id }}" type="radio" {{ $sel == $address->id ? "checked" : "" }}
                                class="custom-control-input" name="seladd2" id="seladd2">
                              <label class="radiofrommodal{{ $address->id }} custom-control-label" for="seladd2"><span
                                  class="font-size16">{{ $address->name }}, {{ $address->phone}}</span>
                                ...
                                <span class="font-weight500"> {{ strip_tags($address->address) }}, <br>
                                  ...
                                  <span>{{ $ci }},{{ $s }},{{ $c }}@if (isset($address->pin_code)),
                                    ({{ $address->pin_code }}) @endif</span>
                                </span></label>
                            </div>
                ...
                <form id="billingForm" action="{{ route('checkout') }}" method="POST">
                  ...
                  where('iso3',$iso3)->first();
                   ...
                   ?>
                      <option value="{{$country_name->id}}"
                        {{ $country_name->id == Session::get('billing')['country_id'] ? 'selected="selected"' : '' }}>
                  ...
                  <div class="form-group">
                    ...
                    <select name="billing_city" id="billing_city" class="form-control">
                      ...
                      @foreach($citys as $c)
                      <option value="{{$c->id}}"
                        {{ $c->id == Session::get('billing')['city'] ? 'selected="selected"' : '' }}>
                        {{$c->name}}
                      </option>
                      @endforeach
                    </select>
                            ...
                            <div class="col-11 col-md-11 col-xl-11">
                              <div class="checkout-page-dtl">
                                ...
                                <p class="pro-des pro-des-one"><b>{{__('staticwords.Price')}}:</b>
                                  ...
                                  <i
                                    class="{{session()->get('currency')['value']}}"></i>{{sprintf("%.2f",($row->ori_offer_price-$tam)*$conversion_rate,2)}}
                                  @else
                                  <i
                                    class="{{session()->get('currency')['value']}}"></i>{{sprintf("%.2f",($row->ori_price-$tam)*$conversion_rate,2)}}
                                  @endif
                                  ...
                                  @if($row->ori_offer_price != 0)
                                  <i
                                    class="{{session()->get('currency')['value']}}"></i>{{sprintf("%.2f",$row->ori_offer_price*$conversion_rate,2)}}
                                  @else
                                  <i
                                    class="{{session()->get('currency')['value']}}"></i>{{sprintf("%.2f",$row->ori_price*$conversion_rate,2)}}
                                  @endif
                                ...
                                <p class="pro-des pro-des-one"> <b>{{__('staticwords.Tax')}} :</b>
                                  ...
                                  Session::forget('igst');
                                  Session::put('indiantax', ['sgst' => $diviedtax*$row->qty, 'cgst' =>
                                  $diviedtax*$row->qty]);
                                  @endphp
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 col-6">
                          - <i class="{{session()->get('currency')['value']}}"></i> <span class=""
                            id="discountedam">{{sprintf("%.2f",Session::get('coupanapplied')['discount']*$conversion_rate,2)}}</span>
                        </div>
                      </div>
                    </div>
                    @endif
