                   ...
                   <div class="margin-top8 col-md-6">
                    <div class="address address-1 box">
                        ...
                        <div class="address-body">
                          @php
                            $c = App\Allcountry::where('id',$address->country_id)->first() ? App\Allcountry::where('id',$address->country_id)->first()->nicename : '';
                            $s = App\Allstate::where('id',$address->state_id)->first() ? App\Allstate::where('id',$address->state_id)->first()->name : '';
