...
<body class="cnt-home">
          ...
          <div class="col-lg-3 col-md-3 col-sm-3 col-0 animate-dropdown top-cart-row">
            ...
            <div class="dropdown dropdown-cart dropdown-cart-one">
              ...
              <div class="square kdrop dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                @php
                $stock = App\AddSubVariant::withTrashed()->find($row->variant_id);
                @endphp
                      ...
                      <div class="row">
                        <div class="col-3 col-xs-3 col-sm-3 col-md-3">
                          <a href="{{url($url)}}" title="{{$pro->name}}">
                            <img class="lazy pro-img2 img-fluid"
  ...
  <div id="brands-carousel" class="logo-slider logo-slider-one">
    <div class="logo-slider-inner">
      ...
      <div id="brand-slider" class="owl-carousel home-owl-carousel custom-carousel brand-slider {{ isset($selected_language) && $selected_language->rtl_available == 1 ? 'owl-rtl' : ''}}">
        ...
        <div class="item m-t-15"> <a href="#" class="image"> <img class="owl-lazy" title="{{ $datas->name }}" width="100px"
              height="110px" data-src="{{url('images/brands/'.$datas->image)}}" alt="{{ $datas->name }}"> </a>
        </div>
        @endforeach
            ...
            <div class="module-body module-small-screen">
              <ul class='list-unstyled'>
                ...
                <li class="last"><a href="{{ route('hdesk') }}"
                    title="Help Center">{{ __('staticwords.HelpCenter') }}</a>
                </li>
              </ul>
            </div>
            <!-- /.module-body -->
              ...
              <div class="row">
                ...
                <div class="col-md-2">
                  <a title="Paypal" target="__blank" href="https://paypal.com"><img
                      data-src="{{ url('images/payment/paypal.png') }}" alt="Paypal" class="lazy img-fluid"></a>
                </div>
                @endif
                ...
                <div class="col-md-2">
                  <a title="Stripe" target="__blank" href="https://stripe.com/"><img
                      data-src="{{ url('images/payment/stripe.png') }}" alt="Razorpay" class="lazy img-fluid"></a>
                </div>
                @endif
                ...
                <div class="col-md-2">
                  <a title="Braintree" target="__blank" href="https://www.braintreepayments.com/"><img
                      data-src="{{ url('images/payment/braintree.png') }}" alt="Braintree" class="lazy img-fluid"></a>
                </div>
                @endif
                ...
                <div class="col-md-2">
                  <a title="Paystack" target="__blank" href="https://paystack.com/"><img
                      data-src="{{ url('images/payment/paystack.png') }}" alt="Paystack" class="lazy img-fluid"></a>
                </div>
                @endif
                ...
                <div class="col-md-2">
                  <a title="Paytm" target="__blank" href="https://paytm.com"><img
                      data-src="{{ url('images/payment/paytm.png') }}" alt="Paytm" class="lazy img-fluid"></a>
                </div>
                @endif
                ...
                <div class="col-md-2">
                  <a title="Razorpay" target="__blank" href="https://razorpay.com/"><img
                      data-src="{{ url('images/payment/razorpay.png') }}" alt="Razorpay" class="lazy img-fluid"></a>
                </div>
                @endif
                ...
                <div class="p-3 col-md-2">
                  <a title="Instamojo" target="__blank" href="https://www.instamojo.com/"><img
                      data-src="{{ url('images/payment/instamojo.png') }}" alt="Razorpay" class="lazy img-fluid"></a>
                </div>
                @endif
                ...
                <div class="p-3 col-md-2">
                  <a title="PayUMoney" target="__blank" href="https://www.payu.in/"><img
                      data-src="{{ url('images/payment/payumoney.png') }}" alt="Razorpay" class="lazy img-fluid"></a>
                </div>
                @endif
                ...
                <div class="p-3 col-md-2">
                  <a title="Payhere" target="__blank" href="https://www.payhere.lk/"><img
                      data-src="{{ url('images/payhere.png') }}" alt="Payhere" class="lazy img-fluid"></a>
                </div>
                @endif
                ...
                <div class="p-3 col-md-2">
                  <a title="Omise" target="__blank" href="https://www.omise.co"><img data-src="{{ url('images/omise.png') }}"
                      alt="omise" class="lazy img-fluid"></a>
                </div>
                @endif
                ...
                <div class="p-3 col-md-2">
                  <a title="Cashfree" target="__blank" href="https://www.cashfree.com/"><img
                      data-src="{{ url('images/cashfree.png') }}" alt="cashfree" class="lazy img-fluid"></a>
                </div>
                @endif
                ...
                <div class="p-3 col-md-2">
                  <a title="mollie" target="__blank" href="https://www.mollie.com/en"><img
                      data-src="{{ url('images/mollie.png') }}" alt="mollie" class="lazy img-fluid"></a>
                </div>
                @endif
                ...
                <div class="p-3 col-md-2">
                  <a title="Rave" target="__blank" href="https://dashboard.flutterwave.com/"><img
                      data-src="{{ url('images/rave.png') }}" alt="rave" class="lazy img-fluid"></a>
                </div>
                @endif
                ...
                <div class="p-3 col-md-2">
                  <a title="Skrill" target="__blank" href="https://www.skrill.com/"><img
                      data-src="{{ url('images/skrill.png') }}" alt="skrill" class="lazy img-fluid"></a>
                </div>
                @endif
          ...
          <div class="clearfix payment-methods">
            <ul>
              ...
              <li><a title="Paypal" target="__blank" href="https://paypal.com"><img
                    data-src="{{ url('images/payment/paypal.png') }}" alt="Paypal" class="lazy img-fluid"></a></li>
              @endif

              @if($Api_settings->stripe_enable=='1')
              <li><a title="Stripe" target="__blank" href="https://stripe.com/"><img
                data-src="{{ url('images/payment/stripe.png') }}" alt="Razorpay" class="lazy img-fluid"></a></li>
              @endif

              @if($Api_settings->braintree_enable=='1')
              <li><a title="Braintree" target="__blank" href="https://www.braintreepayments.com/"><img
                data-src="{{ url('images/payment/braintree.png') }}" alt="Braintree" class="lazy img-fluid"></a></li>
              @endif

              @if($Api_settings->paystack_enable =='1')
              <li><a title="Paystack" target="__blank" href="https://paystack.com/"><img
                data-src="{{ url('images/payment/paystack.png') }}" alt="Paystack" class="lazy img-fluid"></a></li>
              @endif
  ...
  @if(file_exists('js/custom-js.js'))
