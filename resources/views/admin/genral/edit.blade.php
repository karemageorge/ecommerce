      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <br>
            <label class="switch">
              <input type="checkbox" name="APP_DEBUG" @if(env('DEMO_LOCK') != 1) {{ env('APP_DEBUG') == true ? "checked" : "" }} @endif>
              <span class="knob"></span>
            </label>
            <br>
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <br>
            <small class="text-muted"><i class="fa fa-question-circle"></i> If enabled than email verification when user register he/she need to verify his/her email to access the site.</small>
          </div>
        </div>
