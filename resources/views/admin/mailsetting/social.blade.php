					...
					<ul id="payment_tabs" class="nav nav-stacked">
						<li class="active">
							<a href="#tab_1" data-toggle="tab" aria-expanded="false">
								<div class="row">
									...
									<div class="col-md-2">
										<i title="{{ $config->fb_login_enable==1 ? "Active" : "Deactive" }}"
											class="fa fa-circle {{ $config->fb_login_enable==1 ? "text-green" : "text-red" }}"
											aria-hidden="true"></i>
									</div>
								</div>
						...
						<li>
							<a href="#tab_2" data-toggle="tab" aria-expanded="true">
								<div class="row">
									...
									<div class="col-md-2">
										<i title="{{ $config->google_login_enable == 1 ? "Active" : "Deactive" }}"
											class="fa fa-circle {{ $config->google_login_enable == 1 ? "text-green" : "text-red" }}"
											aria-hidden="true"></i>
									</div>
								</div>
							</a>
						...
						<li><a href="#tab_3" data-toggle="tab">
								<div class="row">
									...
									<div class="col-md-2">
										<i title="{{ $config->twitter_enable==1 ? "Active" : "Deactive" }}"
											class="fa fa-circle {{ $config->twitter_enable==1 ? "text-green" : "text-red" }}"
											aria-hidden="true"></i>
									</div>
								</div>
							</a></li>
						<li><a href="#tab_4" data-toggle="tab">
								<div class="row">
									...
									<div class="col-md-2">
										...
										<i title="{{ $config->amazon_enable == 1 ? "Active" : "Deactive" }}"
											class="fa fa-circle {{ $config->amazon_enable==1 ? "text-green" : "text-red" }}"
											aria-hidden="true"></i>
									</div>
								</div>
							</a></li>
						...
						<li><a href="#tab_6" data-toggle="tab">
							<div class="row">
								...
								<div class="col-md-2">
									<i title="{{ $config->linkedin_enable == 1 ? "Active" : "Deactive" }}"
										class="fa fa-circle {{ $config->linkedin_enable == 1 ? "text-green" : "text-red" }}"
										aria-hidden="true"></i>
								</div>
							</div>
						</a>
								...
								<div class="form-group">
									...
									<label class="switch">
										<input id="linkedin_enable" type="checkbox" name="linkedin_enable"
											{{ $config->linkedin_enable == '1' ? "checked" : "" }}>
										<span class="knob"></span>
									</label>
								</div>
