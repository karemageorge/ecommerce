                        ...
                        <li>
                            <a href="#tab_9" data-toggle="tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <i title="{{ $config->payhere_enable==1 ? "Active" : "Deactive" }}"
                                            class="fa fa-circle {{ $config->payhere_enable==1 ? "text-green" : "text-red" }}"
                                            aria-hidden="true"></i>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#tab_11" data-toggle="tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <i title="{{ $config->cashfree_enable==1 ? "Active" : "Deactive" }}"
                                            class="fa fa-circle {{ $config->cashfree_enable==1 ? "text-green" : "text-red" }}"
                                            aria-hidden="true"></i>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#tab_12" data-toggle="tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <i title="{{ $config->skrill_enable==1 ? "Active" : "Deactive" }}"
                                            class="fa fa-circle {{ $config->skrill_enable==1 ? "text-green" : "text-red" }}"
                                            aria-hidden="true"></i>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#tab_13" data-toggle="tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <i title="{{ $config->omise_enable==1 ? "Active" : "Deactive" }}"
                                            class="fa fa-circle {{ $config->omise_enable==1 ? "text-green" : "text-red" }}"
                                            aria-hidden="true"></i>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#tab_14" data-toggle="tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <i title="{{ $config->moli_enable==1 ? "Active" : "Deactive" }}"
                                            class="fa fa-circle {{ $config->moli_enable==1 ? "text-green" : "text-red" }}"
                                            aria-hidden="true"></i>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#tab_15" data-toggle="tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <i title="{{ $config->rave_enable==1 ? "Active" : "Deactive" }}"
                                            class="fa fa-circle {{ $config->rave_enable==1 ? "text-green" : "text-red" }}"
                                            aria-hidden="true"></i>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#tab_16" data-toggle="tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <i title="{{ $config->sslcommerze_enable == 1 ? "Active" : "Deactive" }}"
                                            class="fa fa-circle {{ $config->sslcommerze_enable == 1 ? "text-green" : "text-red" }}"
                                            aria-hidden="true"></i>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#tab_17" data-toggle="tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <i title="{{ $config->iyzico_enable == 1 ? "Active" : "Deactive" }}"
                                            class="fa fa-circle {{ $config->iyzico_enable == 1 ? "text-green" : "text-red" }}"
                                            aria-hidden="true"></i>
                                    </div>
                                </div>
                            </a>
                            ...
                            <form action="{{ route('bt.setting.update') }}" method="POST">
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <input {{ $config->braintree_enable==1 ? "checked" :"" }}
                            ...
                            <form action="{{ route('store.paystackupdate.settings') }}" method="POST">
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <input {{ $config->paystack_enable == 1 ? "checked" :"" }}
                                ...
                                <form action="{{ route('payhere.settings.update') }}" method="POST">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <input name="payhere_enable" id="payhere_enable"
                                            {{ $config->payhere_enable == "1" ? "checked" : "" }} type="checkbox"
                                            class="tgl tgl-skewed">
                                        <label class="tgl-btn" data-tg-off="Deactive" data-tg-on="Active"
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <input name="cashfree_enable" id="cashfree_enable"
                                                {{ $config->cashfree_enable == "1" ? "checked" : "" }} type="checkbox"
                                                class="tgl tgl-skewed">
                                            <label class="tgl-btn" data-tg-off="Deactive" data-tg-on="Active"
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <input name="skrill_enable" id="skrill_enable"
                                                {{ $config->skrill_enable == "1" ? "checked" : "" }} type="checkbox"
                                                class="tgl tgl-skewed">
                                            <label class="tgl-btn" data-tg-off="Deactive" data-tg-on="Active"
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <input name="omise_enable" id="omise_enable"
                                                {{ $config->omise_enable == "1" ? "checked" : "" }} type="checkbox"
                                                class="tgl tgl-skewed">
                                            <label class="tgl-btn" data-tg-off="Deactive" data-tg-on="Active"
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <input name="moli_enable" id="moli_enable"
                                                {{ $config->moli_enable == "1" ? "checked" : "" }} type="checkbox"
                                                class="tgl tgl-skewed">
                                            <label class="tgl-btn" data-tg-off="Deactive" data-tg-on="Active"
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="rave_enable" id="rave_enable"
                                                {{ $config->rave_enable == "1" ? "checked" : "" }} type="checkbox"
                                                class="tgl tgl-skewed">
                                            <label class="tgl-btn" data-tg-off="Deactive" data-tg-on="Active"
                                ...
                                <div class="panel-body">
                                    <form action="{{ route('sslcommerze.settings.update') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{ $config->sslcommerze_enable == 1 ? "checked"  :"" }} type="checkbox"
                                            class="tgl tgl-skewed">
                                            <label class="tgl-btn" data-tg-off="Disable" data-tg-on="Enable"
                                ...
                                <div class="panel-body">
                                    <form action="{{ route('iyzico.settings.update') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{ $config->iyzico_enable == 1 ? "checked"  :"" }} type="checkbox"
                                            class="tgl tgl-skewed">
                                            <label class="tgl-btn" data-tg-off="Disable" data-tg-on="Enable"
