...
<head>
  ...
  <!-- Bootstrap -->
  <link type="text/css" rel="stylesheet" href="{{url('admin/vendor/dist/css/adminboot3.css')}}">
  <!-- Bootstrap Tour -->
  <link type="text/css" rel="stylesheet" href="{{url('css/vendor/bootstrap-tour.min.css')}}">
  <!-- Colorpicker -->
  <link type="text/css" rel="stylesheet"
    href="{{url('admin/vendor/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css')}}">
  <!-- Fontawesome -->
  ...
  <!-- Ionicons -->
  <link type="text/css" rel="stylesheet" href="{{url('admin/vendor/Ionicons/css/ionicons.min.css')}}">
  <link type="text/css" rel="stylesheet" href="{{ url('admin/vendor/icon-font/icon-font.min.css') }}">
  <!-- DataTables -->
  <link type="text/css" rel="stylesheet"
    href="{{url('admin/vendor/datatables.net-bs/css/dataTables.bootstrap.min.css')}}">
  <!-- Select Stylesheets -->
