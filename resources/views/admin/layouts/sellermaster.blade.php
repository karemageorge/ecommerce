...
<head>
  ...
  <!-- Bootstrap -->
  <link rel="stylesheet" type="text/css" href="{{url('admin/vendor/dist/css/adminboot3.css')}}">

  <!-- Font Awesome -->
  <link rel="stylesheet" type="text/css" href="{{url('css/font-awesome.min.css')}}">
  <!-- Ionicons -->
  <link rel="stylesheet" type="text/css" href="{{url('admin/vendor/Ionicons/css/ionicons.min.css')}}">
  <link rel="stylesheet" type="text/css" href="{{ url('admin/vendor/icon-font/icon-font.min.css') }}">
  <!-- Custom alert -->
  <link rel="stylesheet" href="{{ url('css/vendor/alert.css') }}">
  <!-- DataTables -->
  <link rel="stylesheet" type="text/css" href="{{url('admin/vendor/datatables.net-bs/css/dataTables.bootstrap.min.css')}}">
 <!-- Admin LTE Theme With RTL -->
  @if(isset($selected_language) && $selected_language->rtl_available == 1)
    <link rel="stylesheet" href="{{ url('admin/css/rtl/adminlte.min.css') }}"/>
    <link type="text/css" rel="stylesheet" href="{{url('admin/css/rtl/_all-skins.min.css')}}"/>
  @else
    <link type="text/css" rel="stylesheet" href="{{url('admin/vendor/dist/css/adminlte.min.css')}}">
    <link type="text/css" rel="stylesheet" href="{{url('admin/vendor/dist/css/skins/_all-skins.min.css')}}">
  @endif
  <!-- END -->
  <!--Datepicker-->
  ...
  <link rel="stylesheet" type="text/css" href="{{ url('css/vendor/toggle.css') }}">
   <!-- RTL CSS -->
   @if(isset($selected_language) && $selected_language->rtl_available == 1)
   <link rel="stylesheet" href="{{ url('admin/css/rtl/fonts-fa.css') }}">
   <link rel="stylesheet" href="{{ url('admin/css/rtl/bootstrap-rtl.min.css') }}">
   <link rel="stylesheet" href="{{ url('admin/css/rtl/rtl.css') }}">
 @endif
  <!-- TinyMCE Editor -->
