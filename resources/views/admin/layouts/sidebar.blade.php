      ...
      <div class="user-panel">
        <div class="pull-left image">
          @if($userimage)
            ...
            <img src="{{url('images/user/'.$Uimage->image)}}" class="img-rounded img-responsive" alt="User Image">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview {{ Nav::isResource('users') }}">
              ...
              <li class="{{ app('request')->input('filter') == 'customer' ? "active" : "" }}"><a href="{{ route('users.index',['filter' => 'customer']) }} "><i
                ...
                <li class="{{ app('request')->input('filter') == 'admin' ? "active" : "" }}"><a href="{{ route('users.index',['filter' => 'admin']) }}"><i
        ...
        <li id="martools"
          class="treeview {{ Nav::isResource('admin/testimonial') }} {{ Nav::isResource('admin/adv') }} {{ Nav::isResource('admin/hotdeal') }} {{ Nav::isResource('admin/detailadvertise') }}">
          <a href="#">
        ...
        <li id="slider" class="treeview {{ Nav::isRoute('front.slider') }} {{ Nav::isResource('slider') }}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ Nav::isRoute('front.slider') }}">
              <a href="{{route('front.slider')}} "><i class="fa fa-circle-o" aria-hidden="true"></i><span>Category
                  Sliders</span></a>
            </li>
          </ul>
        </li>
        ...
        <li class="{{ Nav::isRoute('admin.wallet.settings') }}"><a href="{{ route('admin.wallet.settings') }}"><i
              class="fa fa-folder" aria-hidden="true"></i>Wallet Settings</a></li>
        ...
        <li class="{{ Nav::isRoute('admin.import.demo') }}">
          <a href="{{ url('/admin/import-demo') }}">
            <i class="fa fa-database" aria-hidden="true"></i> <span>Import Demo</span></a>
        </li>


        <li>
          <a href="{{ url('clear-cache') }}">
            <i class="fa fa-ravelry" aria-hidden="true"></i> <span>Clear Cache</span></a>
        </li>

        {{-- <li id="reppro" class="{{ Nav::isRoute('admin.backup.settings') }}">
          <a href="{{ route('admin.backup.settings') }}">
            <i class="fa fa-futbol-o" aria-hidden="true"></i> <span>Backup</span></a>
        </li> --}}
