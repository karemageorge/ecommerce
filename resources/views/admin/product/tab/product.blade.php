  ...
  <div class="row">
    ...
    <div class="margin-top-15 col-md-4">
      ...
      <select required="" name="child" id="upload_id" class="form-control select2">
        ...
        <option value="{{$category->id}}" {{ old('child') == $category->id ? 'selected="selected"' : '' }}>
          {{$category->title}}
        </option>
        @endforeach
        @endif
    ...
    <div class="margin-top-15 col-md-4">
      ...
      <select name="grand_id" id="grand" class="form-control select2">
        ...
        <option value="{{$category->id}}" {{ old('grand_id') == $category->id ? 'selected="selected"' : '' }}>
          {{$category->title}}
        </option>
        @endforeach
        @endif
    ...
    <div class="margin-top-15 col-md-4">
      ...
      <input {{ old('status') == "0" ? '' : "checked" }} class="tgl tgl-skewed" id="toggle-event3" type="checkbox"/>
      <label class="tgl-btn" data-tg-off="Deactive" data-tg-on="Active" for="toggle-event3"></label>
      <input type="hidden" name="status" value="{{ old('status') ?? "0" }}" id="status3">
