        ...
        <form action="{{ route('admin.theme.update') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select required class="theme_pattern form-control select2" name="key" id="key">
                    ...
                    <option {{ $themesettings && $themesettings->key == 'pattern5' ? "selected" : "" }} value="pattern4">Pattern 4</option>

                    <option {{ $themesettings && $themesettings->key == 'pattern8' ? "selected" : "" }} value="pattern5">Pattern 5</option>
