        ...
        <form action="{{ route('multiCurrency.update',$code) }}" method="POST">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <br>
              <div class="form-group">
                <label>Additonal Charge:</label>
                <input placeholder="eg. 0.50" min="0" step="0.01" value="{{ $additonalAmount }}"
              ...
              <div class="form-group">
                ...
                <div class="input-group iconpicker-container">
                  <input placeholder="Please select currency symbol" data-placement="bottomRight"
                    ...
                    name="currency_symbol" value="{{ $symbol }}" type="text">
  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
         <form method="post" action="{{route('multiCurrency.destroy',$id)}}" class="pull-right">
           @method('delete')
           @csrf
...
<script>
  $('.showcur').iconpicker({
    ...
    icons: ['fa fa-inr', 'fa fa-eur', 'fa fa-bitcoin', 'fa fa-btc', 'fa fa-cny', 'fa fa-dollar', 'fa fa-gg-circle',
      ...
      'fa fa-zwl', 'fa fa-ngr', 'fa fa-eutho', 'fa fa-sgd'
    ],
